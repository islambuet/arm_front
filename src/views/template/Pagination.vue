    ...
    <div>
        <div>
            <ul class="pagination mb-0">
                ...
                <li class="float-left page-item" :class="{ 'disabled': pagination.current_page>=Math.ceil(pagination.total_items/pagination.items_per_page)}">
        ...
        <div class="text-center">
                <ul class="pagination">
                    <li class="float-left mr-2"><p class=" p-2">{{$system_variables.get_label('lable_displaying_item1')}}:</p></li >            
                    <li class="float-left page-item  mr-2">
                        <p class=" p-2">{{(pagination.current_page-1)*pagination.items_per_page}}-{{(pagination.current_page)*pagination.items_per_page}}</p>
                    </li>  
                    <li class="float-left mr-2"><p class=" p-2">{{$system_variables.get_label('lable_displaying_item2')}}:</p></li >            
                    <li class="float-left page-item  mr-2">
                        <p class=" p-2">{{pagination.num_item_showing}}</p>
                    </li> 
                    <li class="float-left mr-2"><p class=" p-2">{{$system_variables.get_label('label_total_item')}}:</p></li >            
                    <li class="float-left page-item  mr-2">
                        <p class=" p-2">{{pagination.num_items}}</p>
                    </li> 
...
export default { 
  ...
  props: {
        ...
        pagination:{
            type: Object,
            default: () => ({current_page:1,items_per_page:50,num_item_showing:0,num_items:10,page_options: [10,20, 30, 50, 500,100]}
            )            
        },
    },    
};
